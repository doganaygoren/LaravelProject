...
<html lang="en">
  <head>
    ...
    <title>Laravel Framework App | </title>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-home"></i> Main Page <span class="fa fa-chevron-down"></span></a>
                    ...
                    <ul class="nav child_menu">
                      <li><a href="/admin">Refresh Admin Page</a></li>
                      <li><a href="/index">Go to Index Page</a></li>
                    </ul>
                  </li>
                  <!-- 22-07-19 -->
                  <li><a><i class="fa fa-book"></i> Blog <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="/admin/blog">Blog List/Add </a></li>
                  ...
                  <li><a href="/admin/about"><i class="fa fa-cog"></i> About </a></li>
                  <li><a href="/admin/settings"><i class="fa fa-book"></i> Settings </a></li>
