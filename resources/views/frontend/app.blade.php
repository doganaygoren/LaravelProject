...
<html>
	...
	<body>
				...
				<div class="container">
					...
					<nav>
						<ul class="nav nav-pills nav-top">
							...
							<li class="phone">
								<span><i class="fa fa-phone"></i>{{$share[0]->phone}}</span>
							</li>
						</ul>
					</nav>
					...
					<div class="container">
						...
						<nav class="nav-main mega-menu">
							...
							<ul class="nav nav-pills nav-main" id="mainMenu">
								...
								<!--09-08-19 -->
								@if(\Illuminate\Support\Facades\Auth::check() && \Illuminate\Support\Facades\Auth::user()->authority()>0)
								<li>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="contact-details">
								<h4>Contact Us</h4>
								<ul class="contact">
									<li><p><i class="fa fa-map-marker"></i> <strong>Address:</strong> {{$share[0]->address}} </p></li>
									<li><p><i class="fa fa-phone"></i> <strong>Phone:</strong> {{$share[0]->phone}} </p></li>
									<li><p><i class="fa fa-phone"></i> <strong>Fax:</strong> {{$share[0]->fax}} </p></li>
									<li><p><i class="fa fa-envelope"></i> <strong>Email:</strong> <a href="mailto:{{$share[0]->mail}}"></a>{{$share[0]->mail}}</p></li>
								</ul>
							</div>
						</div>
						<div class="col-md-2">
		...
		<!-- Specific Page /frontend/Vendor and Views -->
